                ...
                <div class="BElement" style="">
                    ...
                    <div style="float: left; width: 130px; overflow: hidden;">
                        <div class="Commodity">
                            Bản chính</div>
                        <div class="Commodity">
                            <%: Model.MainContract %></div>
                        <div class="Commodity">
                            <%:  Model.MainInvoice %></div>
                        <div class="Commodity">
                            <%:  Model.MainPL %></div>
                        <div class="Commodity">
                            <%:  Model.MainBL %></div>
                        <div class="Commodity">
                            <%:  Model.MainExtend1 %></div>
                        <div class="Commodity">
                            <%:  Model.MainExtend2 %></div>
                    </div>
                    <div style="float: left; width: 119px; overflow: hidden;">
                        <div class="Commodity">
                            Bản sao</div>
                        <div class="Commodity">
                            <%:  Model.SubContract %></div>
                        <div class="Commodity">
                            <%: Model.SubInvoice %></div>
                        <div class="Commodity">
                            <%: Model.SubPL %></div>
                        <div class="Commodity">
                            <%: Model.SubBL %></div>
                        <div class="Commodity">
                            <%: Model.SubExtend1 %></div>
                        <div class="Commodity">
                            <%: Model.SubExtend2 %></div>
                    </div>
                </div>
            </div>
        </div>
                 ...
                 <div style="float: left; width: 50px; overflow: hidden;border-right:1px solid #000;">
                    ...
                    <div style="float: left; width: 250px; overflow: hidden;border-right:1px solid #000;">
                        <div class="Commodity" style="font-weight: bold;padding:5px 10px 15px;border-bottom:1px solid #000;">
                            Commodity in Viet Nam/ Tên hàng</div>
                        ...
                        <div class="Commodity" style="border-bottom:1px solid #000;">
                            <span style="width:200px;"><%: Model.Commodity3%></span></div>
                        <div class="Commodity" style="border-bottom:1px solid #000;">
                            <span style="width:200px;"><%: Model.Commodity4%></span></div>
                        <div class="Commodity" style="border-bottom:1px solid #000;">
                            <span style="width:200px;"><%: Model.Commodity5%></span></div>
                        <div class="Commodity" style="border-bottom:1px solid #000;">
                            <span style="width:200px;"><%: Model.Commodity6%></span></div>
                            <div class="Commodity" style="border-bottom:1px solid #000;">
                            <span style="width:200px;"><%: Model.Commodity7%></span></div>
                            <div class="Commodity" style="border-bottom:1px solid #000;">
                            <span style="width:200px;"><%: Model.Commodity8%></span></div>
                            <div class="Commodity" style="border-bottom:1px solid #000;">
                            <span style="width:200px;"><%: Model.Commodity9%></span></div>
                            <div class="Commodity" style="border-bottom:1px solid #000;">
                            <span style="width:200px;"><%: Model.Commodity10%></span></div>
                    </div>
