...
<div class="PaymentVoucherContent PaymentVoucherContentPrint">
        ...
        <div class="Element"><div class="ELabel">Trả cho</div><div class="EContent"><%= Model.PaidTo%></div></div>
        <div class="Element"><div class="ELabel">Số CMND</div><div class="EContent"><%= Model.IdentifyNo%></div></div>
        <div class="Element"><div class="ELabel">Thuộc Công Ty</div><div class="EContent"><%= Model.BelongTo%></div></div>
        <div class="Element"><div class="ELabel">Địa chỉ</div><div class="EContent"><%= Model.Address1%></div></div>
        <div class="Element"><div class="ELabel"></div><div class="EContent"><%= Model.Address2%></div></div>
        <div class="Element"><div class="ELabel2">Nội dung chi trả</div><div class="EContent2"><%= Model.ContentPayment%></div></div>
        <div class="Element">
            <div class="ELabel2">
        ...
        <div class="Element"><div class="ELabel2">Tổng số tiền dịch vụ lô hàng</div><div class="EContent2"><%= Model.TotalAmountService%></div></div>
        <div class="Element">
            <div class="ELabel3">
                Đi từ </div>
            <div class="EContent3">
        ...
        <div class="Element"><div class="ELabel">Số tiền</div><div class="EContent"><%= Model.TotalAmount%></div></div>
        <div class="Element"><div class="ELabel">Bằng chữ</div><div class="EContent"><%= Model.TotalWords%></div></div>
