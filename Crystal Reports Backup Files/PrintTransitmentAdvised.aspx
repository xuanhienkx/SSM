...
<% using (Html.BeginForm())
   { %>
        <div class="TransitmentAdvisedContrainer">
            ...
            <div class="TransitmentTo"><span>To</span><div style="float:left;"><%= StringUtils.HtmlFilter(Model.AdvisedTo) %></div></div>
            ...
            <div class="GrossWeightRight">
                <table>
                    <tr><td class="Title">Gross weight.kg</td><td>Measurement M3</td></tr>
                     <tr><td style="text-align:center;"><%: Model.Grossweight %></td><td style="text-align:center;"><%: Model.Measurement %></td></tr>
                </table>
              </div>
            </div>
            <div class="MainContent">
                <table border="1px solid Silver" style="width:100%">
                    ...
                    <tr><td><br /></td><td></td><td></td><td></td><td></td>
                    </tr>
                </table>
            </div>
                    ...
                    <tr>
                        <td style="width:500px;">
                            <div class="PayChargeLeft">
                                <table>
                                    ...
                                    <tr><td colspan="2">Times \ Date:</td><td colspan="3"><%: Model.AdvisedTime %></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            Status
                        ...
                        <td>
                            ...
                            <div class="PayContent">
                                <table>
                                    <tr><td>* Freight:</td><td><%:Model.ChargeFreight %></td>
                                    </tr>
                                    <tr><td>* Bill: </td><td><%:Model.ChargeBill %></td>
                                    </tr>
                                    <tr><td>* THC:</td><td><%:Model.ChargeTHC %></td>
                                    </tr>
                                    <tr><td>* AMS:</td><td><%:Model.ChargeAMS %></td>
                                    </tr>
                                    <tr><td>* + VAT for above</td><td><%:Model.ChargeVAT %></td>
                                    </tr>
                                </table>
                            </div>
                            </div>
